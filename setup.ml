...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9444213827ddca9b37e7feabb01ebdab) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = ["no_automatic_syntax"];
          beta_features = [];
          name = "webidl";
          version = "0.1";
          license =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "testWebidl.ml"});
               Executable
                 ({
                     cs_name = "testLexer";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "testLexer.ml"});
               Executable
                 ({
                     cs_name = "testSimpleAst";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "testSimpleAst.ml"});
               Executable
                 ({
                     cs_name = "testParse";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "testParse.ml"});
               Executable
                 ({
                     cs_name = "testGraph";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "testGraph.ml"});
               Executable
                 ({
                     cs_name = "testCalculateBlocking";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "testCalculateBlocking.ml"
                   });
               Executable
                 ({
                     cs_name = "blocklist";
                   ...
                   {exec_custom = false; exec_main_is = "blocklist.ml"})
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\014=\233r\240\011/\029\016\0312\130\180\b\180\249";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
